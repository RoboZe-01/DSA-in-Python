...
# Solution 1 : Brute force / on my own ( using an empty list )


sorted_array_with_duplicates = [1, 1, 2, 3, 3, 3, 4, 5, 5, 6]
...
if __name__== '__main__':
  ...
  solution = Solution()
  result = solution.removeDuplicates(sorted_array_with_duplicates)
  print(f'{result}')      
